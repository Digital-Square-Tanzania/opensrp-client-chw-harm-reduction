...
public class HarmReductionVisitsUtil extends VisitUtils {
    ...
    public static void processVisits() throws Exception {
        processVisits(HarmReductionLibrary.getInstance().visitRepository(), HarmReductionLibrary.getInstance().visitDetailsRepository());
    }
    ...
    public static void manualProcessVisit(Visit visit) throws Exception {
        ...
        VisitDetailsRepository visitDetailsRepository = HarmReductionLibrary.getInstance().visitDetailsRepository();
        VisitRepository visitRepository = HarmReductionLibrary.getInstance().visitRepository();
