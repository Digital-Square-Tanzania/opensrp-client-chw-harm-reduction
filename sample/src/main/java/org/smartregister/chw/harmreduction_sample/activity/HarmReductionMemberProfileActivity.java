...
public class HarmReductionMemberProfileActivity extends BaseHarmReductionProfileActivity {
    ...
    public static void startMe(Activity activity, String baseEntityID) {
        Intent intent = new Intent(activity, HarmReductionMemberProfileActivity.class);
