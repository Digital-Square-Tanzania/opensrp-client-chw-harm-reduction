...
public class BaseHarmReductionProfileActivityTest {
    @Mock
    public BaseHarmReductionProfileActivity baseTestProfileActivity;

    @Mock
    public HarmReductionProfileContract.Presenter profilePresenter;
    ...
    public void formatTime() {
        BaseHarmReductionProfileActivity activity = new BaseTestHarmReductionProfileActivity();
        try {
    ...
    public void onClickBackPressed() {
        baseTestProfileActivity = Mockito.spy(new BaseTestHarmReductionProfileActivity());
