...
public class HarmReductionPhysicalExamActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    ...
    public HarmReductionPhysicalExamActionHelper(Context context, MemberObject memberObject) {
    ...
    public String getPreProcessed() {
        try {
            ...
            String known_allergies = HarmReductionMedicalHistoryActionHelper
                    .known_allergies;
