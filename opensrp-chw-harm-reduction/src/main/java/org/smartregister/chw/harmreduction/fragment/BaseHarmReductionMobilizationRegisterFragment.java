package org.smartregister.chw.harmreduction.fragment;
...
import org.smartregister.chw.harmreduction.adapter.HarmReductionMobilizationRegisterAdapter;
import org.smartregister.chw.harmreduction.dao.HarmReductionMobilizationDao;
...
import org.smartregister.chw.harmreduction.presenter.HarmReductionMobilizationRegisterFragmentPresenter;
import org.smartregister.chw.harmreduction.provider.HarmReductionMobilizationRegisterProvider;
...
public class BaseHarmReductionMobilizationRegisterFragment extends BaseHarmReductionRegisterFragment {

    protected Toolbar toolbar;
    protected LinearLayout emptyViewLayout;
    private HarmReductionMobilizationRegisterAdapter adapter;

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        HarmReductionMobilizationRegisterProvider mobilizationRegisterProvider = new HarmReductionMobilizationRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
    ...
    protected void setUpAdapter() {
        List<HarmReductionMobilizationModel> tbLeprosyMobilizationModels = HarmReductionMobilizationDao.getMobilizationSessions();
        if (tbLeprosyMobilizationModels != null && !tbLeprosyMobilizationModels.isEmpty()) {
            adapter = new HarmReductionMobilizationRegisterAdapter(tbLeprosyMobilizationModels, requireActivity());
    ...
    protected void initializePresenter() {
        ...
        presenter = new HarmReductionMobilizationRegisterFragmentPresenter(this, new BaseHarmReductionRegisterFragmentModel(), viewConfigurationIdentifier);
    }
