...
public class HarmReductionMedicalHistoryActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    ...
    public HarmReductionMedicalHistoryActionHelper(Context context, MemberObject memberObject) {
