...
public class HarmReductionResultsViewProvider implements RecyclerViewProvider<HarmReductionResultsViewProvider.RegisterViewHolder> {
    ...
    public HarmReductionResultsViewProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
