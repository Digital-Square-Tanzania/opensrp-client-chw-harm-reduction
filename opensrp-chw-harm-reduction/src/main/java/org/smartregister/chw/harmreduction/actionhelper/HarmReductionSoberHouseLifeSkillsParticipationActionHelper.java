...
public class HarmReductionSoberHouseLifeSkillsParticipationActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    private static final String LIFE_SKILLS_PARTICIPATION_FIELD_KEY = "life_skills_participation";

    private String lifeSkillsParticipation;
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            lifeSkillsParticipation = JsonFormUtils.getCheckBoxValue(jsonObject, LIFE_SKILLS_PARTICIPATION_FIELD_KEY);
    ...
    public BaseHarmReductionVisitAction.Status evaluateStatusOnPayload() {
        return StringUtils.isNotBlank(lifeSkillsParticipation)
