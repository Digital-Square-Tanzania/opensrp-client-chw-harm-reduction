...
public class HarmReductionReferralsProvidedActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    private static final String REFERRALS_PROVIDED_FIELD_KEY = "referrals_provided";

    private String referralsProvided;
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            referralsProvided = JsonFormUtils.getValue(jsonObject, REFERRALS_PROVIDED_FIELD_KEY);
    ...
    public BaseHarmReductionVisitAction.Status evaluateStatusOnPayload() {
        return StringUtils.isNotBlank(referralsProvided)
