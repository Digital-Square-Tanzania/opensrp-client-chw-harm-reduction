...
import org.smartregister.chw.harmreduction.adapter.HarmReductionUsedNeedlesAndSyringesCollectionRegisterAdapter;
...
import org.smartregister.chw.harmreduction.presenter.HarmReductionUsedNeedlesAndSyringesCollectionRegisterFragmentPresenter;
...
public class BaseHarmReductionUsedNeedlesAndSyringesCollectionRegisterFragment extends BaseHarmReductionRegisterFragment {
    ...
    public void initializeAdapter(Set<View> visibleColumns) {
        HarmReductionRegisterProvider registerProvider = new HarmReductionRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, registerProvider, null);
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            titleView.setText(getString(R.string.harm_reduction_used_needles_collection_sessions));
    ...
    protected void initializePresenter() {
        ...
        presenter = new HarmReductionUsedNeedlesAndSyringesCollectionRegisterFragmentPresenter(this, new BaseHarmReductionRegisterFragmentModel(), viewConfigurationIdentifier);
    }
    ...
    protected void refreshSyncProgressSpinner() {
        ...
        if (syncButton != null) {
            ...
            syncButton.setOnClickListener(view -> {
                JSONObject form;
                try {
                    form = (new FormUtils()).getFormJsonFromRepositoryOrAssets(requireActivity(), Constants.FORMS.HARM_REDUCTION_SAFETY_BOX_COLLECTION);
                    if (form != null) {
