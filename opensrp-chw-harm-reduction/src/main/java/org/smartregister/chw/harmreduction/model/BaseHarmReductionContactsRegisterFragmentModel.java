...
import org.smartregister.chw.harmreduction.util.ConfigHelper;
...
public class BaseHarmReductionContactsRegisterFragmentModel implements HarmReductionRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(HarmReductionLibrary.getInstance().context().applicationContext());
    }
