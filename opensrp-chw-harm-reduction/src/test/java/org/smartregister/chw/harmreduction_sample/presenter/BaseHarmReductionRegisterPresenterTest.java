...
@PrepareForTest(BaseHarmReductionRegisterPresenter.class)
public class BaseHarmReductionRegisterPresenterTest {
    @Mock
    protected BaseHarmReductionRegisterPresenter baseTbLeprosyRegisterPresenter;

    @Mock
    protected HarmReductionRegisterContract.Interactor interactor;
    @Mock
    protected HarmReductionRegisterContract.Model model;
    @Mock
    protected HarmReductionRegisterContract.View baseView;
    private BaseHarmReductionRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseHarmReductionRegisterPresenter(baseView, model, interactor);
    }
