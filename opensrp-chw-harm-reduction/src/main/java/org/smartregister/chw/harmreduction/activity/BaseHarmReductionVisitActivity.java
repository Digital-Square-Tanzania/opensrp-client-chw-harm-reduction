...
public class BaseHarmReductionVisitActivity extends SecuredActivity implements BaseHarmReductionVisitContract.View, View.OnClickListener {

    private static final String TAG = BaseHarmReductionVisitActivity.class.getCanonicalName();
    ...
    public void onBackPressed() {
        displayExitDialog(BaseHarmReductionVisitActivity.this::finish);
    }
