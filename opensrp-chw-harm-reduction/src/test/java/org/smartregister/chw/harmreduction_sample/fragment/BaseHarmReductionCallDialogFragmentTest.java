...
@PrepareForTest(BaseHarmReductionCallDialogFragment.class)
public class BaseHarmReductionCallDialogFragmentTest {
    @Spy
    public BaseHarmReductionCallDialogFragment baseTestCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseHarmReductionCallDialogFragment.class, "MEMBER_OBJECT", tbleprosyMemberObject);
    }
