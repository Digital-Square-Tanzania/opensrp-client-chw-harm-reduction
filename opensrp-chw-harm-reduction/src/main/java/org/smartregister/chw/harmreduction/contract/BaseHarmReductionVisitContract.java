...
public interface BaseHarmReductionVisitContract {
    interface View extends VisitView {
        ...
        void startForm(BaseHarmReductionVisitAction tbleprosyHomeVisitAction);

        void startFormActivity(JSONObject jsonForm);

        void startFragment(BaseHarmReductionVisitAction tbleprosyHomeVisitAction);
        ...
        Map<String, BaseHarmReductionVisitAction> getTbLeprosyVisitActions();
        ...
        void initializeActions(LinkedHashMap<String, BaseHarmReductionVisitAction> map);
    ...
    interface Interactor {
        ...
        void submitVisit(boolean editMode, String memberID, Map<String, BaseHarmReductionVisitAction> map, InteractorCallBack callBack);
    }
    ...
    interface InteractorCallBack {
        ...
        void preloadActions(LinkedHashMap<String, BaseHarmReductionVisitAction> map);
