package org.smartregister.chw.harmreduction_sample.provider;
...
public class BaseHarmReductionRegisterProviderTest {
    @Mock
    public CommonPersonObjectClient commonPersonObjectClient;
    @Mock
    public View.OnClickListener listener;
    @Mock
    public HarmReductionRegisterProvider.RegisterViewHolder viewHolder;
    @Mock
    private HarmReductionRegisterProvider testRegisterProvider;
    ...
    public void updateMemberGender() throws Exception {
        Activity activity = Mockito.mock(Activity.class);
        Resources resources = Mockito.mock(Resources.class);
        HarmReductionRegisterProvider provider = new HarmReductionRegisterProvider(activity, listener, listener, null);
        Map<String, String> map = new HashMap<>();
