...
import org.smartregister.chw.harmreduction.model.BaseHarmReductionContactsRegisterFragmentModel;
import org.smartregister.chw.harmreduction.presenter.BaseHarmReductionRegisterContactFragmentPresenter;
...
public class BaseHarmReductionContactFragment extends BaseRegisterFragment implements HarmReductionRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        HarmReductionRegisterProvider tbLeprosyRegisterProvider = new HarmReductionRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
    ...
    @Override
    public HarmReductionRegisterFragmentContract.Presenter presenter() {
        return (HarmReductionRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseHarmReductionRegisterContactFragmentPresenter(this, new BaseHarmReductionContactsRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseHarmReductionProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
