package org.smartregister.chw.harmreduction_sample.repository;
...
import org.smartregister.chw.harmreduction_sample.BuildConfig;
import org.smartregister.chw.harmreduction_sample.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        HarmReductionLibrary.getInstance().visitRepository().createTable(database);
        HarmReductionLibrary.getInstance().visitDetailsRepository().createTable(database);
