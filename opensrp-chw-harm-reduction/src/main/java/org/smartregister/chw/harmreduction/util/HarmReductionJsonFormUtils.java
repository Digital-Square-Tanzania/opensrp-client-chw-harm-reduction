...
public class HarmReductionJsonFormUtils extends org.smartregister.util.JsonFormUtils {
    ...
    protected static FormTag formTag(AllSharedPreferences allSharedPreferences) {
        ...
        formTag.appVersion = HarmReductionLibrary.getInstance().getApplicationVersion();
        formTag.databaseVersion = HarmReductionLibrary.getInstance().getDatabaseVersion();
        return formTag;
    }
    ...
    public static void tagEvent(AllSharedPreferences allSharedPreferences, Event event) {
        ...
        event.setClientApplicationVersion(HarmReductionLibrary.getInstance().getApplicationVersion());
        event.setClientDatabaseVersion(HarmReductionLibrary.getInstance().getDatabaseVersion());
    }
