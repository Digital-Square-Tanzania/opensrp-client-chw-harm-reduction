...
public class HarmReductionSoberHouseDiseaseScreeningActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    private static final String SCREENING_TESTS_DONE_FIELD_KEY = "screening_tests_done";

    private String screeningTestsDone;
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            screeningTestsDone = JsonFormUtils.getCheckBoxValue(new JSONObject(jsonPayload), SCREENING_TESTS_DONE_FIELD_KEY);
    ...
    public BaseHarmReductionVisitAction.Status evaluateStatusOnPayload() {
        return StringUtils.isNotBlank(screeningTestsDone)
