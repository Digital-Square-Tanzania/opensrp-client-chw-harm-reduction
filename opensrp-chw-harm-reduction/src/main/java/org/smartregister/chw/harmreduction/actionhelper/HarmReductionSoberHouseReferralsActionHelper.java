...
public class HarmReductionSoberHouseReferralsActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    private static final String FACILITY_REFERRALS_PROVIDED_FIELD_KEY = "facility_referrals_provided";

    private String facilityReferralsProvided;
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            facilityReferralsProvided = JsonFormUtils.getValue(jsonObject, FACILITY_REFERRALS_PROVIDED_FIELD_KEY);
    ...
    public BaseHarmReductionVisitAction.Status evaluateStatusOnPayload() {
        return StringUtils.isNotBlank(facilityReferralsProvided)
