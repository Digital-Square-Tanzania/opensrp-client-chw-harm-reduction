...
public class BaseHarmReductionRegisterActivityTest {
    @Mock
    public Intent data;
    @Mock
    private BaseHarmReductionRegisterActivity baseTestRegisterActivity = new BaseHarmReductionRegisterActivity();
