...
public class UpdateHarmReductionMemberProfileActivity extends BaseHarmReductionProfileActivity {
    private static final Logger log = LoggerFactory.getLogger(UpdateHarmReductionMemberProfileActivity.class);
    ...
    public static void startMe(Activity activity, String baseEntityID) {
        Intent intent = new Intent(activity, UpdateHarmReductionMemberProfileActivity.class);
    ...
    public void openHarmReductionContactRegister(){
        Intent intent = new Intent(this, HarmReductionContactRegister.class);
