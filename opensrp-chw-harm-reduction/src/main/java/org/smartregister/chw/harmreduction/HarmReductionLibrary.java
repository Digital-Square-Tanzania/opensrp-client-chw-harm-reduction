package org.smartregister.chw.harmreduction;
...
public class HarmReductionLibrary {
    private static HarmReductionLibrary instance;
    ...
    public void setSubmitOnSave(boolean submitOnSave) {
        HarmReductionLibrary.submitOnSave = submitOnSave;
    }
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new HarmReductionLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static HarmReductionLibrary getInstance() {
        if (instance == null) {
    ...
    private HarmReductionLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
