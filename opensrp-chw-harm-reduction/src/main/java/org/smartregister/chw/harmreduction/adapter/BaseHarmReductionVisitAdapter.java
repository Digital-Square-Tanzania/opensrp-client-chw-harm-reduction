...
public class BaseHarmReductionVisitAdapter extends RecyclerView.Adapter<BaseHarmReductionVisitAdapter.MyViewHolder> {
     ...
     * @return
     */
    private BaseHarmReductionVisitAction getByPosition(int position) {
        int count = -1;
        for (Map.Entry<String, BaseHarmReductionVisitAction> entry : tbleprosyVisitActionList.entrySet()) {
    ...
    public void onBindViewHolder(@NotNull MyViewHolder holder, int position) {
        ...
        BaseHarmReductionVisitAction tbleprosyVisitAction = getByPosition(position);
        ...
        if (StringUtils.isNotBlank(tbleprosyVisitAction.getSubTitle())) {
            ...
            if (tbleprosyVisitAction.isEnabled()) {
                ...
                boolean isOverdue = tbleprosyVisitAction.getScheduleStatus() == BaseHarmReductionVisitAction.ScheduleStatus.OVERDUE &&
    ...
    private int getCircleColor(BaseHarmReductionVisitAction tbleprosyVisitAction) {
    ...
    private void bindClickListener(View view, final BaseHarmReductionVisitAction tbleprosyVisitAction) {
