...
public class BaseHarmReductionRegisterFragment extends BaseRegisterFragment implements HarmReductionRegisterFragmentContract.View {
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.harm_reduction));
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseHarmReductionRegisterFragmentPresenter(this, new BaseHarmReductionRegisterFragmentModel(), null);
    }
