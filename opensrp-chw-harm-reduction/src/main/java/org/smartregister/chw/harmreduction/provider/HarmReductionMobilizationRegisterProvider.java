...
public class HarmReductionMobilizationRegisterProvider extends HarmReductionResultsViewProvider {

    protected Set<org.smartregister.configurableviews.model.View> visibleColumns;

    public HarmReductionMobilizationRegisterProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
