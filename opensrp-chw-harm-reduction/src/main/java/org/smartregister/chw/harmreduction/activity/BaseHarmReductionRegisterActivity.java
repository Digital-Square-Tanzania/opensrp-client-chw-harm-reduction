...
import org.smartregister.chw.harmreduction.model.BaseHarmReductionRegisterModel;
import org.smartregister.chw.harmreduction.presenter.BaseHarmReductionRegisterPresenter;
...
public class BaseHarmReductionRegisterActivity extends BaseRegisterActivity implements HarmReductionRegisterContract.View {
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BaseHarmReductionRegisterFragment) {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BaseHarmReductionRegisterActivity.class);
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new HarmReductionBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BaseHarmReductionRegisterPresenter(this, new BaseHarmReductionRegisterModel(), new BaseHarmReductionRegisterInteractor());
    }

    @Override
    protected BaseRegisterFragment getRegisterFragment() {
        return new BaseHarmReductionRegisterFragment();
    }
    ...
    @Override
    public HarmReductionRegisterContract.Presenter presenter() {
        return (HarmReductionRegisterContract.Presenter) presenter;
    }
    ...
    public void startClientProcessing() {
        try {
            ...
            HarmReductionUtil.getClientProcessorForJava().processClient(HarmReductionUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
