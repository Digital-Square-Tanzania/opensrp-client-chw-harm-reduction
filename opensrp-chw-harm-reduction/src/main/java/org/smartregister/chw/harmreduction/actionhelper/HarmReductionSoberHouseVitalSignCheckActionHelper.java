...
public class HarmReductionSoberHouseVitalSignCheckActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    private static final String TESTING_SERVICES_FIELD_KEY = "testing_services";
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            testingServices = JsonFormUtils.getValue(jsonObject, TESTING_SERVICES_FIELD_KEY);
    ...
    public BaseHarmReductionVisitAction.Status evaluateStatusOnPayload() {
        return StringUtils.isNotBlank(testingServices)
