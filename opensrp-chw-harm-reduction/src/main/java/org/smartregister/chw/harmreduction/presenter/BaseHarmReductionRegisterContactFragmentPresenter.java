...
public class BaseHarmReductionRegisterContactFragmentPresenter implements HarmReductionRegisterFragmentContract.Presenter {

    protected WeakReference<HarmReductionRegisterFragmentContract.View> viewReference;
    ...
    public BaseHarmReductionRegisterContactFragmentPresenter(HarmReductionRegisterFragmentContract.View view, HarmReductionRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    protected HarmReductionRegisterFragmentContract.View getView() {
