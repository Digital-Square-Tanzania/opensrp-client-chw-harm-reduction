...
import org.smartregister.chw.harmreduction.listener.BaseHarmReductionCallWidgetDialogListener;

public class BaseHarmReductionCallDialogFragment extends DialogFragment implements BaseHarmReductionCallDialogContract.View {

    public static final String DIALOG_TAG = "BaseHarmReductionCallDialogFragment_DIALOG_TAG";
    private static MemberObject MEMBER_OBJECT;
    private View.OnClickListener listener = null;

    public static BaseHarmReductionCallDialogFragment launchDialog(Activity activity, MemberObject MO) {
        BaseHarmReductionCallDialogFragment dialogFragment = BaseHarmReductionCallDialogFragment.newInstance();
    ...
    public static BaseHarmReductionCallDialogFragment newInstance() {
        return new BaseHarmReductionCallDialogFragment();
    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        setUpPosition();
        if (listener == null) {
            listener = new BaseHarmReductionCallWidgetDialogListener(this);
        }
    ...
    @Override
    public void setPendingCallRequest(BaseHarmReductionCallDialogContract.Dialer dialer) {
