...
public class HarmReductionHtsActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    ...
    public HarmReductionHtsActionHelper(Context context, MemberObject memberObject) {
    ...
    public String getPreProcessed() {
        try {
            ...
            String is_client_diagnosed_with_any = HarmReductionMedicalHistoryActionHelper.is_client_diagnosed_with_any;
            String any_complaints = HarmReductionMedicalHistoryActionHelper.any_complaints;
            String known_allergies = HarmReductionMedicalHistoryActionHelper.known_allergies;
            String any_hematological_disease_symptoms = HarmReductionMedicalHistoryActionHelper.any_hematological_disease_symptoms;
            String complications_previous_surgical = HarmReductionMedicalHistoryActionHelper.complications_previous_surgical;
            String type_of_blood_for_glucose_test = HarmReductionMedicalHistoryActionHelper.type_of_blood_for_glucose_test;
            String blood_for_glucose = HarmReductionMedicalHistoryActionHelper.blood_for_glucose;
            String blood_for_glucose_test = HarmReductionMedicalHistoryActionHelper.blood_for_glucose_test;
            String diagonised_others = HarmReductionMedicalHistoryActionHelper.client_diagnosed_other;
            String genital_examination = HarmReductionPhysicalExamActionHelper.genital_examination;
            String diastolic = HarmReductionPhysicalExamActionHelper.diastolic;
            String systolic = HarmReductionPhysicalExamActionHelper.systolic;
    ...
    public BaseHarmReductionVisitAction.Status evaluateStatusOnPayload() {
        ...
        if (status.equalsIgnoreCase(VisitUtils.Ongoing)) {
            return BaseHarmReductionVisitAction.Status.PARTIALLY_COMPLETED;
        }
