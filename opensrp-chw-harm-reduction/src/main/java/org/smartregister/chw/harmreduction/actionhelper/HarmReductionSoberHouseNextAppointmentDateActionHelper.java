...
public class HarmReductionSoberHouseNextAppointmentDateActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    private static final String NEXT_APPOINTMENT_DATE_FIELD_KEY = "next_appointment_date";
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            nextAppointmentDate = JsonFormUtils.getValue(jsonObject, NEXT_APPOINTMENT_DATE_FIELD_KEY);
