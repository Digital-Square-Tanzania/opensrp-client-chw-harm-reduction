...
public class HarmReductionSafeInjectionServicesActionHelper implements BaseHarmReductionVisitAction.HarmReductionVisitActionHelper {
    private static final String SAFE_INJECTION_TOOLS_FIELD_KEY = "safe_injection_tools";

    private String safeInjectionTools;
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            safeInjectionTools = JsonFormUtils.getValue(jsonObject, SAFE_INJECTION_TOOLS_FIELD_KEY);
    ...
    public BaseHarmReductionVisitAction.Status evaluateStatusOnPayload() {
        return StringUtils.isNotBlank(safeInjectionTools)
